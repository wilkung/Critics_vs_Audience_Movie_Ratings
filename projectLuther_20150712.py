...
def processMovie(url):
    ...
    return (movieID, genres, review, metascore, budget)    
...
movieNum = 1     # Movie number we are currently processing
#totalMovies = 9308
totalMovies = 10
    ...
    for searchResult in results.children:
        ...
        if isinstance(searchResult, Tag):
            ...
            if len(movieBox) == 1:
                ...
                movieID, genres, review, metascore, budget = processMovie(anchor['href'])
...
#while movieNum != totalMovies:
#    
#    page = urllib.urlopen('http://www.imdb.com/title/tt2582802/')
